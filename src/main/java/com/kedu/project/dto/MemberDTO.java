...
public class MemberDTO {
	...
	public MemberDTO(String id, String password, String name, String englishName, String employmentType,
			...
			String hire_date, String dept_code, String job_code, String rank_code, Timestamp created_time,
			String personalEmail, String officePhone, String mobilePhone, Timestamp birthDate, String calendarType) {
		super();
		this.id = id;
