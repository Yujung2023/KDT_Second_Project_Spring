...
public class ApprovalDTO {
	...
	public ApprovalDTO(int seq, String title, String writer, String writer_id, String rejectReason, String comments,
			String status, Timestamp writeDate, List<MemberDTO> approvers, List<MemberDTO> referenceList,
			String myStatus) {
		super();
		this.seq = seq;
		this.title = title;
